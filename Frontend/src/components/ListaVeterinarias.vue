<template>
  <div class="container">
    <div>
      <h4 class="fw-bold text-center">Lista de Veterinarias</h4> 
    ...
    <table class="table table-hover" id="table_id" >
      <thead class="table-light">
        <tr>
          ...
          <th class="encLista" scope="col">Servicios</th>
        </tr>
      </thead>
      <tbody>
        <tr
          ...
          :key="index"
          @click="$router.push(`/panel/listaveterinarias/${veterinaria._id}`)"
        ...
        >
          ...
          <td class="detLista">{{ veterinaria.servicios }}</td>
